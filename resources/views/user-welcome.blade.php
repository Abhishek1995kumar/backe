                                ...
                                <li>
                                    @if (Route::has('login'))
                                        <div class="d-flex justify-content-between sm:fixed sm:top-0 sm:right-0 p-6 text-right">
                                            ...
                                            @else
                                                <a href="{{ route('login') }}" style="background-color:#0000;color:#000000;">Log in</a>

                                                @if (Route::has('register'))
                                                    <a href="{{ route('register') }}" style="background-color:#0000;color:#000000;">Register</a>
                                                @endif
                                            @endauth
                                        </div>
                                    @endif
